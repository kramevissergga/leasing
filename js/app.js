(() => {
    ...
    class SelectConstructor {
        ...
        selectInit(originalSelect, index) {
            ...
            selectItem.insertAdjacentHTML("beforeend", `<div class="${this.selectClasses.classSelectBody}"><div class="${this.selectClasses.classSelectOptions}"></div></div>`);
        ...
        searchActions(selectItem) {
            ...
            selectInput.addEventListener("input", (function() {
                selectOptionsItems.forEach((selectOptionsItem => {
                    if (selectOptionsItem.textContent.toUpperCase().includes(selectInput.value.toUpperCase())) selectOptionsItem.hidden = false;
                }));
            }));
        }
 ...
 */    var MEDIA_PREFERS_REDUCED_MOTION = "(prefers-reduced-motion: reduce)";
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        var videoSliderEl = document.querySelector(".videos__slider");
        if (videoSliderEl) {
            var videoSlider = new Splide(videoSliderEl, {
                perPage: 4,
                perMove: 1,
                arrows: true,
                pagination: false,
        ...
        var factsSliderEl = document.querySelector(".facts__slider");
        if (factsSliderEl) {
            var factsSlider = new Splide(factsSliderEl, {
                perPage: 2,
                arrows: false,
                pagination: true,
                gap: 10,
        ...
        var ratesSliderEl = document.querySelector(".rates__slider");
        if (ratesSliderEl) {
            var ratesSlider = new Splide(ratesSliderEl, {
                perPage: 2,
                arrows: false,
                pagination: true,
                gap: 10,
